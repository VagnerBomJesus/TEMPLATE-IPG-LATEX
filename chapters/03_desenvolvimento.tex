...
% Este é o capítulo que descreve o desenvolvimento do projeto.
% =============================================================================
...
% - Quais são os processos e os dados a serem gerados pelo sistema?
% - Quais são as restrições operacionais?
% - Quem irá utilizar o sistema?
% - De que forma esses elementos influenciam o projeto do sistema?
...
%   requisitos? Usar um diagrama que identifique todos os componentes
%   principais do sistema e as suas relações.
...
% Responder à seguinte questão:
% - Como é que o módulo foi implementado? A descrição deve ser
%   suficientemente detalhada para explicar todos os aspetos da
%   implementação. Usar figuras, tabelas, diagramas e excertos de código
%   para suportar a explicação.
...
% Repetir a estrutura anterior para cada módulo identificado no
% diagrama de arquitetura do sistema.
Descrever a implementação do módulo B.

% ---- 3.5 Implementação do Módulo \ldots ----
...
% Se o projeto consistiu no desenvolvimento de um protótipo (aplicativo de
% software ou dispositivo físico), apresentar e descrever esse protótipo
% com as suas principais funcionalidades.
